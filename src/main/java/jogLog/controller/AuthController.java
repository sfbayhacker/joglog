...
import jogLog.security.JwtAuthenticationToken;
 ...
 * @author Kish
 */
@Api(value = "/auth", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE, protocols = "http")
@RestController
